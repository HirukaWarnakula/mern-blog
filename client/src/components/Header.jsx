    ...
    <Navbar className='border-b-2'>
      <div className="flex items-center w-full">
        ...
        <div className="flex flex-col lg:flex-row lg:gap-8 ml-auto mr-36">
          <Navbar.Link href="/" className="text-gray-900 dark:text-white hover:text-blue-500" active={pathv ==="/"}>
            Home
          </Navbar.Link>
          <Navbar.Link href="/about" className="text-gray-900 dark:text-white hover:text-blue-500"active={pathv ==="/about"}>
            About
          </Navbar.Link>
          <Navbar.Link href="/projects" className="text-gray-900 dark:text-white hover:text-blue-500"active={pathv ==="/projects"}>
            Projects
          </Navbar.Link>
        </div>
      </Navbar.Collapse>
